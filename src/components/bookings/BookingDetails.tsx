...
import {useBookingsParams, useCreateBooking, useDeleteBooking, useUpdateBooking} from './bookingsHook';
...
export default function BookingDetails ({booking, bookable}) {
  ...
  console.log(`isBooker: ${isBooker}, ${booking?.bookerId} user: ${JSON.stringify(user)}`);
